  ...
  <el-container class="main-container">
    ...
    <el-container>
      ...
      <el-aside width="200px">
        <el-menu :default-active="activeSubMenu" class="sub-menu">
      ...
      <el-main>
        <el-form :model="form" label-position="top" class="task-form">
          ...
          <el-form-item label="Prompt">
            <el-input v-model="form.prompt" type="textarea" :rows="3" placeholder="What do you want to do?" />
          </el-form-item>
          ...
          <el-form-item label="Task Name">
            ...
            >
              <el-option v-for="item in predefinedTasks" :key="item" :label="item" :value="item" />
            </el-select>
          </el-form-item>
          ...
          <el-col :span="3">
            <el-form-item label="Unit">
              <el-input-group>
                <el-select v-model="form.durationUnit" style="width: 80px">
            ...
            <el-col :span="3">
              <el-form-item label="End Time">
                <el-date-picker v-model="form.endTime" type="datetime" placeholder="Select date" />
              </el-form-item>
            </el-col>
            <el-col :span="3">
              <el-form-item label="Deadline">
                <el-date-picker v-model="form.deadline" type="datetime" placeholder="Select date" />
              </el-form-item>
            </el-col>
          </el-row>
...
.el-input-group .el-select {
  margin-left: 5px; /* Add some space between input and select */
}
</style>
