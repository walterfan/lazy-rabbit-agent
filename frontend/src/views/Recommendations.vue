...
const emailPreviewBody = computed(() => {
  const rec = recommendationStore.currentRecommendation;
  const userName =
    authStore.user?.full_name || authStore.user?.email || '用户';
          ...
          <div class="space-y-6">
            ...
            <div v-if="isAdmin">
              ...
              <p v-if="selectedUser" class="mt-2 text-sm text-blue-600">
                已选择用户: <span class="font-medium">{{ selectedUser.full_name || selectedUser.email }}</span>
              </p>
              ...
              <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    :placeholder="recommendationStore.currentRecommendation ? '' : '生成推荐后自动生成邮件内容'"
                  />
            ...
            <div class="flex items-center justify-between mb-4">
              <div>
                ...
                <p class="text-gray-600 mt-1">
                  用户: {{ adminRecommendationStore.currentUser?.full_name || adminRecommendationStore.currentUser?.email }}
                </p>
              </div>
              <div
                ...
                <div class="text-sm text-gray-700">
                  ...
                  <div class="mt-1">
                    ...
                    <span class="ml-2 font-medium">
                      ...
                      ({{ recommendationStore.streamingDays[streamingDayTab]?.temperature_low }}°C - {{ recommendationStore.streamingDays[streamingDayTab]?.temperature_high }}°C)
                    </span>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div class="grid grid-cols-2 gap-2 text-sm">
                  ...
                  <div>
                    ...
                    <span class="ml-2 font-medium">{{ recommendationStore.streamingWeather.temperature }}°C</span>
                  </div>
                </div>
              </div>
