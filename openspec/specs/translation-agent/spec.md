# translation-agent Specification

## Purpose

Translation agent: translate English content from URL, pasted text, or uploaded file (PDF/text/markdown) into Chinese, with explanation and summary. Supports streaming, downloadable markdown, and HTML rendering.
